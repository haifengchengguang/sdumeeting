...
var clientPublicKey =client.getPublicKey().toString('hex');
...
//把p,g,clientPublicKey发送到server端
...
var c1=encrypt('hello-你好',clientSecret);
console.log(c1);
